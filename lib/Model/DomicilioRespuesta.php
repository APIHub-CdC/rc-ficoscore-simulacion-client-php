...
class DomicilioRespuesta implements ModelInterface, ArrayAccess
{
    ...
    protected static $RCCPMTypes = [
        ...
        'ciudad' => 'string',
        'estado' => '\rc\ficoscore\simulacion\Client\Model\CatalogoEstados',
        'cp' => 'string',
        'fecha_residencia' => 'string',
        'numero_telefono' => 'string',
        'tipo_domicilio' => '\rc\ficoscore\simulacion\Client\Model\CatalogoTipoDomicilio',
        'tipo_asentamiento' => '\rc\ficoscore\simulacion\Client\Model\CatalogoTipoAsentamiento',
