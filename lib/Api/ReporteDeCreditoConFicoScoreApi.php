...
namespace rc\ficoscore\simulacion\Client\Api;
...
use rc\ficoscore\simulacion\Client\HeaderSelector;
use rc\ficoscore\simulacion\Client\ObjectSerializer;

class ReporteDeCreditoConFicoScoreApi
{
    ...
    {
        $returnType = '\rc\ficoscore\simulacion\Client\Model\Consultas';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\rc\ficoscore\simulacion\Client\Model\Consultas',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\rc\ficoscore\simulacion\Client\Model\Errores',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\rc\ficoscore\simulacion\Client\Model\Creditos';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\rc\ficoscore\simulacion\Client\Model\Creditos',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\rc\ficoscore\simulacion\Client\Model\DomiciliosRespuesta';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\rc\ficoscore\simulacion\Client\Model\DomiciliosRespuesta',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\rc\ficoscore\simulacion\Client\Model\Empleos';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\rc\ficoscore\simulacion\Client\Model\Empleos',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\rc\ficoscore\simulacion\Client\Model\Mensajes';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\rc\ficoscore\simulacion\Client\Model\Mensajes',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\rc\ficoscore\simulacion\Client\Model\Respuesta';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\rc\ficoscore\simulacion\Client\Model\Respuesta',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\rc\ficoscore\simulacion\Client\Model\Scores';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\rc\ficoscore\simulacion\Client\Model\Scores',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
