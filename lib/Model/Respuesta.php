...
class Respuesta implements ModelInterface, ArrayAccess
{
    ...
    protected static $RCCPMTypes = [
        ...
        'persona' => '\rc\ficoscore\simulacion\Client\Model\PersonaRespuesta',
        'consultas' => '\rc\ficoscore\simulacion\Client\Model\Consulta[]',
        'creditos' => '\rc\ficoscore\simulacion\Client\Model\Credito[]',
        'domicilios' => '\rc\ficoscore\simulacion\Client\Model\DomicilioRespuesta[]',
        'empleos' => '\rc\ficoscore\simulacion\Client\Model\Empleo[]',
        'scores' => '\rc\ficoscore\simulacion\Client\Model\Score[]',
        'mensajes' => '\rc\ficoscore\simulacion\Client\Model\Mensaje[]'
    ];
